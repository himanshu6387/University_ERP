                ...
                {!openQR ? (
                    <div className="popup-content">
                        ...
                        <div className="popup-header">
                            ...
                            <h2 className="popup-title">Welcome to SRSV ED&W Trust! 🎉</h2>
                            <p className="popup-subtitle">SRSV Educational & Welfare Trust</p>
                        </div>
                        ...
                        <div className="popup-body">
                            <p className="popup-text">
                                ...
                                education for Economical Poor Students.
                            </p>
